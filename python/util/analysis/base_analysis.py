...
class BaseAnalysis(object):
    ...
    def append_report_fig(self, fig, name: str, selected_idx=None, selected_event_id=None):
        print(name, selected_idx, selected_event_id)
        lst = [f'{e}' for e in [name, selected_idx,
                                selected_event_id] if e is not None]
        key = ':'.join(lst)
        self.report_figs[key] = fig
        self.report_figs_note[key] = f'Add notes for {key}'
        logger.debug(f'Remembered {key} fig: {fig}')
        return fig

    def remove_report_fig(self, key: str):
        try:
            return self.report_figs.pop(key)
        except KeyError:
            return
        except:
            return
    ...
    def _method_plot_quality_index(self, selected_idx, selected_event_id, **kwargs):
        ...
        fig.tight_layout()
        self.append_report_fig(fig, 'QualityIndex',
    ...
    def _method_plot_connectivity(self, selected_idx, selected_event_id, **kwargs):
        ...
        self.append_report_fig(fig, 'Connectivity',
                               selected_idx, selected_event_id)
    ...
    def _method_plot_events(self, selected_idx, selected_event_id, **kwargs):
        ...
        fig = mne.viz.plot_events(
            epochs.events, epochs.info['sfreq'], on_missing='ignore', event_id=epochs.event_id, show=False)
        self.append_report_fig(fig, 'Events', selected_idx)
        return fig
    ...
    def _method_plot_sensors(self, selected_idx, selected_event_id, **kwargs):
        ...
        self.append_report_fig(fig, 'Sensors', selected_idx)
        return fig
    ...
    def _method_plot_evoked(self, selected_idx, selected_event_id, **kwargs):
        ...
        self.append_report_fig(fig, 'Evoked', selected_idx, selected_event_id)
        return fig
